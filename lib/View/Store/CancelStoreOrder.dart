...
class CancelStoreOrder extends StatefulWidget {
  const CancelStoreOrder({super.key});

  @override
  State<CancelStoreOrder> createState() => _CancelStoreOrderState();
}

class _CancelStoreOrderState extends State<CancelStoreOrder> {
  @override
  ...
  getAllOrderList() async {
    var res = await Webservices.getMap(
        "$get_user_order_details?user_id=$userId&status=Cancel");
