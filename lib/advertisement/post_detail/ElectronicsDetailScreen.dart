...
import 'package:ealaa_userr/advertisement/UpdatePosts/update_ElectronicsAd.dart';
...
class _ElectronicsDetailScreenState extends State<ElectronicsDetailScreen> {
  List<Map<String, String>> detailElements = [
    ...
    {'title': 'Type', 'Image': 'assets/icons_for_car/ic_ad.png'},
    {'title': 'Brand', 'Image': 'assets/icons_for_car/ic_ad.png'},
    {'title': 'Condition', 'Image': 'assets/icons_for_car/ic_ad.png'},
    {'title': 'Warranty', 'Image': 'assets/icons_for_car/ic_ad.png'},
    {'title': 'Storage', 'Image': 'assets/icons_for_car/ic_ad.png'},
    {'title': 'Location', 'Image': 'assets/icons_for_car/ic_ad.png'},
  ...
  adsPostDetailsFavourite() async {
    await Webservices.getMap(
        "$baseUrl$ads_post_details_favourite?ads_details_id=${result?.electronicsAdsId}&type=${widget.ads_post}&user_id=$userId");
    setState(() {});
    getAdsPostDetails();
  }
                    ...
                    children: [
                      Container(
                        ...
                        child: CachedNetworkImage(
                          imageUrl: result?.electronicsAdsImage ?? '',
                          fit: BoxFit.contain,
                          height: 300,
                      ...
                      Padding(
                        ...
                        child: Text(
                          result?.electronicsAdsDescription ?? '',
                          maxLines: 1,
                          style: TextStyle(
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: 15),
                        child: Text(
                          "${result?.electronicsAdsPrice ?? ''} OMR",
                          style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.bold,
                              fontSize: 18),
                      ...
                      Padding(
                        ...
                        child: RoundButton(
                          ...
                          onTap: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateElectronicsAd(adType: result?.adsType ?? '', advertisement_category_id: result?.adsCategoryId ?? '', advertisement_sub_category_id: result?.adsSubCategoryId ?? '', ads_post_id: widget.ads_post_id ?? '')));
                          },
                          fontsize: 18,
                          fontweight: FontWeight.w500,
                        ),
  ...
  String getTextMethod({required int index}) {
    switch (index) {
      ...
      case 4:
        return result?.warrantyName??'';
      case 5:
        return result?.storageName??'';
      case 6:
        return '${result?.cityName??''} ${result?.stateName??''}';
      case 7:
        return result?.electronicsAdsPrice??'';
      case 8:
        return result?.electronicsAdsPostId??'';
      case 9:
