...
class AdMySaveSearchedView extends StatefulWidget {
  const AdMySaveSearchedView({super.key});

  @override
  State<AdMySaveSearchedView> createState() => _AdMySaveSearchedState();
}

class _AdMySaveSearchedState extends State<AdMySaveSearchedView> {
  bool isMap = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text(
          'My Saved Searches', // Your badge count here
          style: TextStyle(
            color: Colors.white,
            fontSize: 20,
          ),
