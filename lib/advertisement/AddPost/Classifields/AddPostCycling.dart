...
class AddPostCycling extends StatefulWidget {
  ...
  const AddPostCycling({super.key,
  ...
  @override
  State<AddPostCycling> createState() => _AddPostCyclingState();
}

class _AddPostCyclingState extends State<AddPostCycling> {
  bool loader = false;
  ...
  clickOnPostAnAd() async {
    if (productPicture != null &&
      ...
      var res = await Webservices.postDataWithImageFunction(
          ...
          files: files,
          context: context,
          apiUrl: add_advertisement_Classified_Cycling_posts);
      loader = false;
      setState(() {});
