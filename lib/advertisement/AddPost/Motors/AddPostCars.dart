...
class AddPostCars extends StatefulWidget {
  ...
  @override
  State<AddPostCars> createState() => _AddPostCarsState();
}

class _AddPostCarsState extends State<AddPostCars> {
  bool loader = false;
  ...
  clickOnPostAnAd() async {
    if (productPicture != null &&
      ...
      var res = await Webservices.postDataWithImageFunction(
          ...
          files: files,
          context: context,
          apiUrl: add_advertisement_Cars_posts);
      loader = false;
      setState(() {});
