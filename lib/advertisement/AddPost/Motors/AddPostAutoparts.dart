...
class AddPostAutoparts extends StatefulWidget {
  ...
  const AddPostAutoparts(   {super.key,
  ...
  @override
  State<AddPostAutoparts> createState() => _AddPostAutopartsState();
}

class _AddPostAutopartsState extends State<AddPostAutoparts> {
  bool loader = false;
  final imgPicker = ImagePicker();
  File? productPicture;
  TextEditingController phoneNumber = TextEditingController();
  TextEditingController price = TextEditingController();
  TextEditingController autoAccessories = TextEditingController();
  ...
  clickOnPostAnAd() async {
    if (productPicture != null &&
        ...
        autoAccessories.text.trim().isNotEmpty &&
      ...
      'auto_accessories_type':autoAccessories.text.trim(),
      ...
      var res = await Webservices.postDataWithImageFunction(
          ...
          files: files,
          context: context,
          apiUrl: add_advertisement_Motors_Auto_Accessories_posts);
      loader = false;
      setState(() {});
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    commonTextFormField(
                        width: width * 0.43,
                        controller: autoAccessories,
                        hintText: 'Auto Accessories type'),
                    commonTextFormField(
                        width: width * 0.43,
                        controller: price,
                        hintText: 'Price'),
