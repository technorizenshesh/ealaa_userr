...
import 'package:ealaa_userr/Model/advertisement_model/AddPostModel.dart';
...
class AddAdsCommercialoffice extends StatefulWidget {
  ...
  @override
  State<AddAdsCommercialoffice> createState() => _AddAdsCommercialofficeState();
}

class _AddAdsCommercialofficeState extends State<AddAdsCommercialoffice> {
  bool loader = false;
  ...
  clickOnPostAnAd() async {
    if (productPicture != null &&
      ...
      var res = await Webservices.postDataWithImageFunction(
          ...
          files: files,
          context: context,
          apiUrl: add_advertisement_CommercialPlot_posts);
      loader = false;
      setState(() {});
      final resdata = AddPostModel.fromJson(res);
      if (resdata.status == "1") {
        showSnackbar(context, resdata.message!);
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AdBottomBar(),));
      } else {
        showSnackbar(context, resdata.message!);
      }
    } else {
