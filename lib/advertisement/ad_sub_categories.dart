  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          widget.getAdsWithCategoryHomeResult.name ?? "",
          // Your badge count here
          style: TextStyle(
            color: Colors.white,
            fontSize: 20,
          ),
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => CategoryPostsScreen(
                        adsPost: widget.ads_post,
                        adsCategoryId: widget.advertisement_category_id,
                        adsSubCategoryId: values,
                      ),
                    ),
                  );
                          ...
                          return GestureDetector(
                            onTap: () {
                              if (subcategoryList[index].selected == null ||
                                ...
                                subcategoryList[index].selected = '1';
                                resdata?.selectedCount =
                                    (int.parse(resdata?.selectedCount ?? '0') +
                                            int.parse(subcategoryList[index]
                                                    .subcount ??
                                                '0'))
                                        .toString();
                                setState(() {});
