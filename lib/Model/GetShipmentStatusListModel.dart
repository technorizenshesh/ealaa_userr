class GetShipmentStatusListModel {
  List<GetShipmentStatusListResult> result;
  String message;
  String status;

  GetShipmentStatusListModel({
    required this.result,
    required this.message,
    required this.status,
  });

  factory GetShipmentStatusListModel.fromJson(Map<String, dynamic> json) => GetShipmentStatusListModel(
    result: List<GetShipmentStatusListResult>.from(json["result"].map((x) => GetShipmentStatusListResult.fromJson(x))),
...
class GetShipmentStatusListResult {
  ...
  factory GetShipmentStatusListResult.fromJson(Map<String, dynamic> json) => GetShipmentStatusListResult(
