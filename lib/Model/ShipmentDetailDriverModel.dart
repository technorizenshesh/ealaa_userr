class ShipmentDetailDriverModel {
  ShipmentDetailDriverResult? result;
  String message;
  String status;

  ShipmentDetailDriverModel({
    required this.result,
    required this.message,
    required this.status,
  });

  factory ShipmentDetailDriverModel.fromJson(Map<String, dynamic> json) => ShipmentDetailDriverModel(
    result:json["result"]==null
      ? null:ShipmentDetailDriverResult.fromJson(json["result"]),
    message: json["message"],
    status: json["status"],
  );
}

class ShipmentDetailDriverResult {
  ...
  factory ShipmentDetailDriverResult.fromJson(Map<String, dynamic> json) => ShipmentDetailDriverResult(
