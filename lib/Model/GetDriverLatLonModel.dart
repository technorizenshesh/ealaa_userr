class GetDriverLatLonModel {
  GetDriverLatLonResult result;
  String message;
  String status;

  GetDriverLatLonModel({
    required this.result,
    required this.message,
    required this.status,
  });

  factory GetDriverLatLonModel.fromJson(Map<String, dynamic> json) => GetDriverLatLonModel(
    result: GetDriverLatLonResult.fromJson(json["result"]),
...
class GetDriverLatLonResult {
  ...
  factory GetDriverLatLonResult.fromJson(Map<String, dynamic> json) => GetDriverLatLonResult(
    drId: json["dr_id"],
