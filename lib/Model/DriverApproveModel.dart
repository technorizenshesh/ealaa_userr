class DriverApproveModel {
  DriverApproveResult result;
  String message;
  String status;
  ...
  factory DriverApproveModel.fromJson(Map<String, dynamic> json) => DriverApproveModel(
    result: DriverApproveResult.fromJson(json["result"]),
...
class DriverApproveResult {
  ...
  factory DriverApproveResult.fromJson(Map<String, dynamic> json) => DriverApproveResult(
